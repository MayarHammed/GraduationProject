...
import "./Chat.css";
// images
import pro from "../../images/6q.jpg";
import pro1 from "../../images/5q.jpg";
import pro2 from "../../images/icons8-sent-48.png";
import pro3 from "../../images/icons8-sent-26.png";
import pro4 from "../../images/case.png";
import Zoom from "react-reveal/Zoom";
import icon from "../../images/icons8-next-64.png";
    ...
    <Zoom top>
      <div className="CHAT_App">
        <div class="card">
          ...
          <div class="heading">
            Chat With Doctor
            <span className="span_Doctor_Family">
              Home <span className="handeing_Back">Back</span>
            </span>
          </div>
          <div class="content">
        ...
        <div className="container">
          <img className="case_p1" src={pro4} alt="Doctor" />
          <img className="case_p2" src={pro4} alt="Doctor" />
          <img className="case_p3" src={pro4} alt="Doctor" />
          <img className="case_p4" src={pro4} alt="Doctor" />
          <img className="case_p5" src={pro4} alt="Doctor" />

          <div className="chatbox">
            <div className="col-1">
              <div className="msg-row">
                <div className="msg-text text12">
                  <p>مرحبا كيف الحال</p>
                </div>
                <img src={pro} alt="Doctor" />
              </div>
              <div className="msg-row msg-row1">
                <img src={pro1} alt="Doctor" />
                <div className="msg-text text123">
                  <p>الحمد لله بخير </p>
                </div>
              </div>
              <div className="msg-row">
            ...
            <div className="col-2">
              <img className="iimg" src={pro4} alt="Doctor" />
              <img className="iimg1" src={pro4} alt="Doctor" />
              <img className="iimg2" src={pro4} alt="Doctor" />
              <img className="iimg3" src={pro4} alt="Doctor" />

              <button className="chat_buttons">
                <div>
                  <span>
                    <p className="span_p1">Send!</p>
                    <p>
                      {" "}
                      <img src={pro2} alt="send" />
                    </p>
                  </span>
                </div>
                <div>
                  <span>
                    <p className="span_p2">Send</p>
                    <p>
                      <img src={pro3} alt="send" />
                    </p>
                  </span>
                </div>
              </button>
