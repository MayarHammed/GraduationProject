...
import pro10 from "../../images/coronavirus-png.png";
...
function Chat() {
  return(
    ...
    <div class="card">
      <div class="heading">
        Chat With Doctor <span>Doctor Family</span>
      </div>
      <div class="content">
      ...
      <button className="Code to Infinity">Home!</button>
    </div>{" "}
